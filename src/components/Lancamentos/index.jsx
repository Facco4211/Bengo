    ...
    return (
        <>
            <div className={style.gridPai}>
                <Link href="/games" className={style.item1} style={{ gridArea: "box1" }}>
                    <div>
                    ...
                    <div className={style.preco}>
                        <Link href="/games">COMPRAR</Link> <p>R$ 299,00</p>
                    </div>
                </Link>
                <div className={style.item2} style={{ gridArea: "box2" }}>
                    ...
                    <Link href="/games" className={style.imageDeExemplo}>
                ...
                <Link href="/games" className={style.item3} style={{ gridArea: "box3" }}>
                    <div>
                        <strong>EM ALTA</strong>
                    ...
                    <div className={style.preco}>
                        <Link href="/games">COMPRAR</Link> <p>R$ 199,00</p>
                    </div>
                </Link>
                <div className={style.item4} style={{ gridArea: "box4" }}>
                    <div className={style.texto}>
                        ...
                        <div className={style.preco}>
                            <Link href="/games">Comprar</Link> <p>R$ 379,90</p>
                        </div>
                    </div>
                    <Link href="/games" className={style.imageDeExemplo}>
                ...
                <div className={style.item5} style={{ gridArea: "box5" }}>
                    <div className={style.texto}>
                        ...
                        <div className={style.preco}>
                            <Link href="/games">COMPRAR</Link><p>R$ 399,50</p>
                        </div>
                    </div>
                    <Link href="/games" className={style.imageDeExemplo}>
